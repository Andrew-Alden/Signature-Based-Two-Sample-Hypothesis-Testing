...
def level_k_contribution(X, Y, k, phik=lambda x: 1, unbiased=True, u_stat=False):
    """
    ...
    :param u_stat:      Whether to use U-statistic estimator.
